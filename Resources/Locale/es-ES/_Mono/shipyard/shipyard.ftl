shipyard-direction-message = ¡Tu {$shipName} se encuentra aproximadamente a {$distance} metro(s) hacia el {$direction}!

ship-access-denied = Necesitas la escritura de la nave para acceder a esto.
ship-voucher-cooldown-active = ¡El período de reutilización del vale sigue activo durante {NATURALFIXED($remainingTime, 1)} minutos!

voucher-current-redemptions = Este vale tiene [color=yellow]{$count}[/color] canjes restantes.
