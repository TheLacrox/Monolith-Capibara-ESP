...
id-card-access-level-emergency-shuttle-repeal = Revocación Total de Emergencia

id-card-access-level-head-of-personnel = Representante de Estación
id-card-access-level-head-of-security = Coronel
...
id-card-access-level-atmospherics = Atmósferas
...
id-card-access-level-external = Exterior
