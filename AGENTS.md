...
## Tooling (`_Capibara/`)
- `agent-workflows.md` — shared incremental procedures for upstream sync, translation, validation,
  entity refreshes, and PR handoff.
- `glossary.md` — canonical es-ES terms; inject into every translation agent.
- `validate-agent-setup.ps1` — structural gate for root agent docs and repository Codex skills.
...
## Verify
- `pwsh _Capibara/validate-agent-setup.ps1` — agent entrypoints and skills structurally sound.
